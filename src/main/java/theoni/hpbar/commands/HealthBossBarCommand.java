...
public class HealthBossBarCommand extends Command {

    Main plugin;
    Config config;
    Config mobs;

    public HealthBossBarCommand(Main plugin) {
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        ...
        switch (args[0]) {
            ...
            case "info":
                ...
                break;
            case "help":
                sender.sendMessage("Health boss bar commands:\n/hpbar reload - Reload all configs\n/hpbar about - About the plugin");
                break;
        }
        return true;
    }
